...
public class Constants {
	...
	public static volatile int driveMaxIntroJose;
	public static volatile int driveMaxInicioJose;
	public static volatile int driveMaxCreditosJose;
	public static volatile int driveMaxCierreJose;
	public static volatile int driveMaxPlotTwistJose;
    ...
    public static int promedioPerdidaJefesJose;
